...
export default class Camioneta extends Vehiculo {
    ...
    constructor (dominio: string, precio: number, marca: string, modelo:string, año:number, capacidad? : number) {
        super(dominio, precio, marca, modelo, año, 'Camioneta');
    ...
    public mostrar() : string {
        return `Camioneta { Dominio: ${this.dominio} es un ${this.marca}-${this.modelo} modelo ${this.año} con precio ${this.precio.toString()}, posee ${this.capacidad} de capacidad}`;
    }
